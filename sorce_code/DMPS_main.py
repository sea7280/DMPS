...
class Application(tk.Frame):
    def __init__(self,master=None):
        ...
        self.calcbox = entry.create_calcbox(self.frameList)
        ...
        button.create_button(master, self.frameList, self.entry_list, self.listbox, self.chk, self.textbox, self.calcbox)
